...
import { hashSha256, hextounit8, padKey } from '../utils/hex';
...
const decryptFile=async (data, key,iv) => {
    return new Promise( (resolve, reject) => {
        crypto.subtle.importKey("raw", Uint8Array.from(key), 'AES-CBC', false, ['encrypt', 'decrypt'])
...
export default async (fileId, key)=>{
    try {
        // Get File Metadata
